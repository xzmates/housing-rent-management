...
function createActions(caller) {
  ...
  return {
    ...
    getHouseAvailability: query.getHouseAvailability,
    getTenantOccupancy: query.getTenantOccupancy,
    ...
    confirmHistoricalLeaseImport: command.confirmHistoricalLeaseImport,
